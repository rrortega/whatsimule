...
[![licencia](https://img.shields.io/npm/l/rrortega-whatsimule.svg?color=green)](LICENSE)
...
[![TypeScript](https://img.shields.io/badge/TypeScript-Listo-3178c6.svg)](https://www.typescriptlang.org/)
...
- 📞 **Llamadas Nativas de Entrada y Salida**: Simulación oficial de llamadas de voz y video en pantalla completa para iOS y Android, en dirección entrante y saliente. Soporta interacción de timbrado con rechazo/aceptación y riel deslizable en llamadas entrantes, estados de llamada saliente ("Llamando...", "Marcando...", "Llamada colgada") con botón rojo de cuelgue, e indicadores de tarjeta de llamada ("Llamada perdida" / "Llamada de voz sin respuesta") en la corriente del chat.
